...
#Processing the text to vectorize it
#Converting each character into a numeric ID
#by splitting the tokens first
...
#Converts tokens to character IDs
...
#5 Generations of texts
start = time.time()
states = None
next_char = tf.constant(['YO:', 'YO:', 'YO:', 'YO:', 'YO:'])
result = [next_char]
